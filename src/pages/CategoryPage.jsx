...
import { getCategories, createCategory, deleteCategory, getProducts } from '../api/api';
                  ...
                  return (
                    <div key={p._id}
                      ...
                      <div className="w-12 h-12 rounded-lg overflow-hidden bg-dark-800 shrink-0 border border-dark-500">
                        {p.image ? (
                          <img src={`http://localhost:5050${p.image}`} alt={p.name} className="w-full h-full object-cover" />
                        ) : (
